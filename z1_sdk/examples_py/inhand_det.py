...
def main():
    # —— 1. 内参和畸变系数硬编码 —— #
    K = np.array([
        [631.3256856003788,   0.0,               324.11646638254126],
        [0.0,                 631.3093321979653, 246.65753824813333],
        [0.0,                 0.0,               1.0]
    ], dtype=np.float64)

    dist = np.array([
        0.045669776801512504,
        0.8127342760310322,
        0.002203819221810671,
        0.00177648605400157,
        -4.1821404380423814
    ], dtype=np.float64)
...
# ]
    ...
    T_cb = np.array([
        [-0.00007629, -0.01211961,  0.99992655,  -0.10249319208650204],
        [-0.99969708,  0.02461114, 0.00022203,  0.030454334005602757],
        [-0.02461202, -0.99962363,  -0.01211782, 0.27342018645622955],
        [ 0.0,                   0.0,                   0.0,                   1.0]
    ], dtype=np.float64)
