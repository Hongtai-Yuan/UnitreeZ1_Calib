...
def init_calibration_params(pattern_cols=10, pattern_rows=7, square_size=0.024):
    """
    初始化标定参数
...
def camera_calibrate(images_path, pattern_params):
    ...
    image_files.sort(key=lambda x: int(x.replace('img', '').replace('.png', '')))
...
if __name__ == "__main__":
    ...
    images_path = 'handeye_img_pose/img'
    arm_pose_file = 'handeye_img_pose/img/pose.txt'
